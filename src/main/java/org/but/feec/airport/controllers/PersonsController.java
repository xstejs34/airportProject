...
import org.but.feec.airport.api.PersonDeleteView;
...
//        GlyphsDude.setIcon(exitMenuItem, FontAwesomeIcon.CLOSE, "1em");
    ...
    private void initializeTableViewSelection() {
        ...
        delete.setOnAction((ActionEvent event) -> {
            ...
            try {
                ...
                System.out.println(personView.getId());
                idTextField.setText(String.valueOf(personView.getId()));
                ...
                personDeleteConfirmationDialog();
    ...
    private void personDeleteConfirmationDialog() {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
        alert.setTitle("Person Deleted Confirmation");
        alert.setHeaderText("Person was successfully deleted.");
